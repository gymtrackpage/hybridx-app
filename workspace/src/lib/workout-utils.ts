 ...
 */
export function getWorkoutForDay(program: Program, startDate: Date, targetDate: Date): { day: number; workout: Workout | RunningWorkout | null; } {
    ...
    if (workoutForDay) {
        // Ensure the workout object has the programType, inheriting from the parent program
        return { 
            day: dayOfProgram, 
            workout: {
                ...workoutForDay,
                programType: workoutForDay.programType || program.programType,
            }
        };
    }
